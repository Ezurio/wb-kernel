...
static int ifx_twt_setup(struct wireless_dev *wdev, struct ifx_twt twt)
{
...
static int ifx_twt_teardown(struct wireless_dev *wdev, struct ifx_twt twt)
{
	struct brcmf_cfg80211_vif *vif;
	struct brcmf_if *ifp;
...
static int ifx_twt_oper(struct wireless_dev *wdev, struct ifx_twt twt)
{
	int ret = -1;
